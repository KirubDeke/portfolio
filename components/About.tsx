                ...
                <div className="w-full lg:w-3/5 xl:w-2/3 lg:ml-12 xl:ml-16">
                    ...
                    <div className="flex border-b mb-8">
                        <button
                            ...
                            className={`px-6 py-3 text-lg font-medium ${activeTab === 'about' ? 'border-b-4 border-current' : 'opacity-70'}`}
                        >
                            About Me
                        </button>
                        <button
                            onClick={() => setActiveTab('education')}
                            className={`px-6 py-3 text-lg font-medium ${activeTab === 'education' ? 'border-b-4 border-current' : 'opacity-70'}`}
                        >
                            Education
                        </button>
                    </div>
                    ...
                    <div className="text-lg">
                        ...
                        {activeTab === 'education' && (
                            <div>
                                <h1 className="text-3xl lg:text-4xl font-bold text-red-500 mb-8">Education Qualification</h1>

                                <div className="space-y-8">
                                    <div>
                                        <h2 className="text-2xl font-medium font-light text-gray-500">BSC in SE</h2>
